...
import com.lokesh.fooddelight.adapter.CartAdapter
import com.lokesh.fooddelight.adapter.FoodAdapter
import com.lokesh.fooddelight.database.order.FoodDatabase
...
import com.lokesh.fooddelight.model.Food
import com.lokesh.fooddelight.util.ConnectionManager
...
class FoodActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(ConnectionManager().checkConnectivity(this@FoodActivity as Context)) {
            ...
            if (isFav) {
                val draw =  ContextCompat.getDrawable(applicationContext,R.drawable.ic_action_fav_checked)
            ...
            imgbtnFav.setOnClickListener {
                if(!isFav){
                    ...
                    if(result){
                        ...
                        val noDraw =  ContextCompat.getDrawable(applicationContext,R.drawable.ic_action_fav)
